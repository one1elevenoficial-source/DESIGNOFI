...
// Estilos para animações de ouro e ícones
const goldStyles = `
  @keyframes gold-glow {
    0%, 100% {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <Card 
          className="card bg-card/50 border-border hover:border-info/30 transition-colors"
          style={{
          ...
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              <div className="w-10 h-10 rounded-lg bg-info/10 flex items-center justify-center">
                <MessageSquare className="w-5 h-5 text-info card-icon" />
              </div>
            </div>
            <p className="text-2xl font-bold gold-metric-animate mt-3">{totalMessages.toLocaleString('pt-BR')}</p>
        ...
        >
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              <div className="w-10 h-10 rounded-lg bg-info/10 flex items-center justify-center">
                <Zap className="w-5 h-5 text-info card-icon" />
              </div>
            </div>
            <p className="text-2xl font-bold gold-metric-animate mt-3">{activeLeads}</p>
            <p className="text-xs text-muted-foreground mt-1">Leads Ativos</p>
          </CardContent>
        </Card>

        <Card 
          className="card bg-card/50 border-border hover:border-success/30 transition-colors"
          style={{
            border: '1px solid rgba(255,215,0,0.3)',
            background: 'linear-gradient(135deg, rgba(255,215,0,0.05) 0%, transparent 100%)',
          }}
          ...
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              <div className="w-10 h-10 rounded-lg bg-success/10 flex items-center justify-center">
                <Target className="w-5 h-5 text-success card-icon" />
              </div>
            </div>
            <p className="text-2xl font-bold gold-metric-animate mt-3">{conversionRate.toFixed(1)}%</p>
            <p className="text-xs text-muted-foreground mt-1">Taxa de Conversão</p>
          </CardContent>
        </Card>

        <Card 
          className="card bg-card/50 border-border hover:border-warning/30 transition-colors"
          style={{
            border: '1px solid rgba(255,215,0,0.3)',
            background: 'linear-gradient(135deg, rgba(255,215,0,0.05) 0%, transparent 100%)',
          }}
          ...
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              <div className="w-10 h-10 rounded-lg bg-warning/10 flex items-center justify-center">
                <Trophy className="w-5 h-5 text-warning card-icon" />
              </div>
            </div>
            <p className="text-2xl font-bold gold-metric-animate mt-3">{hotLeads}</p>
        ...
        >
          <CardContent className="pt-5">
            <div className="flex items-start justify-between">
              <div className="w-10 h-10 rounded-lg bg-success/10 flex items-center justify-center">
                <TrendingUp className="w-5 h-5 text-success card-icon" />
              </div>
            </div>
            <p className="text-2xl font-bold gold-shine-animate mt-3">{totalConversions}</p>
